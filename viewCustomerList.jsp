          ...
          <ul class="nav__list" role="menubar">
            <li class="nav__item  nav__item--isActive">
             ...
             >  
              ...
              <li class="nav__item">
                <a href="/kedai_kereta_sewa_abang_2.2/ReservationController?action=listBooking"><img src="styleAdm/ico/car.svg" width="40"></a></li>
        ...
        <main class="main">
          ...
          <section class="section">
            <header class="section__header">
              <h2 class="section__title">Customer</h2>
                ...
                <a href="#" class="project__link focus--box-shadow">
                  <div class="project__wrapper">
                    <span class="project__inform-name" style="color:white">
                        <c:out value="${cust.custic}" />
                    </span>
                    <span class="project__inform-name" style="color:white">
                        <c:out value="${cust.custusername}" />
                    </span>
                    <span class="project__inform-name" style="color:white">
                        <c:out value="${cust.custname}" />
                    </span>
                    <span class="project__inform-name" style="color:white">
                        <c:out value="${cust.custphone}" />
                    </span>
                    </div>
                </a>
                <BR>
